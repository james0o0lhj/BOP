...
p = {
    ...
    "result_filenames": [
        "YOLO-ICP-method3-pc500-multi8_lmo-test.csv",  # "YOLO-ICP_tless-test-primesense.csv" "hodan-iros15_tless-test-primesense.csv"  YOLO-ICP_lmo-test.csv   hodan-iros15_lmo-test.csv
    ],
