...
p = {
    ...
    "n_top": -1,
    # Pose error function.
    # Options: 'vsd', 'mssd', 'mspd', 'ad', 'adi', 'add', 'cus', 're', te,  rete  proj
    "error_type": "proj",
    # VSD parameters.
    "vsd_deltas": {
        "hb": 15,
    ...
    "result_filenames": [
        "YOLO-ICP-method1-pc500-multi1_lmo-test.csv",  # "YOLO-ICP_tless-test-primesense.csv"  YOLO-ICP_lmo-test.csv  hodan-iros15_tless-test-primesense.csv  hodan-iros15_lmo-test.csv
    ],
