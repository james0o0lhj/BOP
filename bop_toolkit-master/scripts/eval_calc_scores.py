...
p = {
    ...
    "error_dir_paths": [
        r"YOLO-ICP-method1-pc500-multi1_lmo-test\\error=proj_ntop=-1",    #"\\YOLO-ICP_tless-test-primesense\\error=add_ntop=1"   YOLO-ICP_lmo-test\\error=add_ntop=1  hodan-iros15_tless-test-primesense\\error=add_ntop=1  hodan-iros15_lmo-test\\error=add_ntop=1
    ], 
